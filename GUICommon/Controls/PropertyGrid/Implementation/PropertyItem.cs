...
namespace MPDisplay.Common.Controls.PropertyGrid
{
    public class PropertyItem : Control
    {
        ...
        public static readonly DependencyProperty CategoryOrderProperty = DependencyProperty.Register("CategoryOrder", typeof(int), typeof(PropertyItem), new UIPropertyMetadata(0));
        ...
        private void GetChildProperties()
        {
            ...
            Properties = PropertyGridUtilities.GetCategorizedProperties(propertyItems);
        }
