...
# Installer Vars
!define VERSION "TestBuild_0.9.4.0"
...
OutFile "${BUILD_FOLDER}\Packages\TestBuilds\${VERSION}\${INSTALLER_EXE_NAME}"
...
!define MUI_HEADERIMAGE_BITMAP "${BUILD_FOLDER}\header_Test.bmp"
!define MUI_UNHEADERIMAGE_BITMAP "${BUILD_FOLDER}\header_Test.bmp"
!define MUI_WELCOMEFINISHPAGE_BITMAP "${BUILD_FOLDER}\headerSide_Test.bmp"
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "${BUILD_FOLDER}\headerSide_Test.bmp"
...
LangString DESC_UnInstall_Full ${LANG_GERMAN} "There is 3rd party skins installed, Would you like to remove these also?"
